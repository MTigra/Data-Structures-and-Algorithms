...
/**
 * Operation object that implements MINUS binary operation
 */
 ...
 public:
     ...
     // If a given operator symbol is
     // not a '-', an exception is thrown
     virtual int operation(char op, int a, int b, int c) override;
     virtual Arity getArity() const override;
 }; // class MinusOp

/**
 * Operation object that implements & binary operation
 */
