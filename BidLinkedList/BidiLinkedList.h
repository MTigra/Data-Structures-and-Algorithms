...
public:
    ...
    public:
        ...
        /** \brief Initialization with a node element */
    ...
    public:
        ...
        // UPD: unfortunately, can't proclaim this methods due to encapsulation reqs
        ///** \brief Sets a given node \a insNode as the next node after this
    ...
    protected:
        ...
        /** \brief Internal implementation of insertAfter() w/o any checking
         *
...
public:
     ...
     *  
     *  If either \a beg or \a end is nullptr, an exception is thrown
 ...
 // this part of code is active only if you'd like to get the highest mark
     ...
     *
     *  If either \a beg or \a end is nullptr, an exception is thrown
     *  A cut chain should be a part of the list, otherwise unpredictable behavior
     *  is expected
     *
     *  <b style='color:orange'>Must be implemented by students</b>
     */
     ...
     *  \returns cut node
     *
     *  If \a node is nullptr, an exception is thrown
     *  A cut node should be a part of the list, otherwise unpredictable behavior
     *  is expected
     *
     *  <b style='color:orange'>Must be implemented by students</b>
     */
...
public:
    ...
    /** \brief Find all occurrences of a value \a val and returns a C-style array with
     ...
     *  \return cut node if found, nullptr otherwise
     */
